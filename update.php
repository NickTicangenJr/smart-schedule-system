...
<body>
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh">
        <form class="border shadow p-3 m-2 rounded" action="php/update.php" method="post" style="width: 450px;">
        <button type="button" class="btn-close" aria-label="Close" onclick="history.back()"></button>
            <h4 class="text-center p-3" style="color: #4CAF50;">BSIT-1A Update Schedule</h4>
