...
if(isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM bsit_1b WHERE id=$id";
    ...
    include '../db_conn.php';
        ...
        // --    (monday_stat, tue_stat, wed_stat, thu_stat, fri_stat) 
           ...
           $result = mysqli_query($conn, $sql);
           if ($result) {
                 header("Location: ../bsit_1b.php?success=successfully updated");
           }else {
              header("Location: ../bsit_1b_update.php?error=unknown error occurred&$user_data");
           }
}
