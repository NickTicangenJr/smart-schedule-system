			...
			<div class="card">
				...
				<div class="p-3 m-5">
					...
					if (mysqli_num_rows($res) > 0) { ?>
						...
						<h1 class="display-4 fs-1">BSIT - 1A</h1>
					...
					<table>
						<thead>
							<tr>
								<th>
									<form method="POST" action="emails/send_email_bsit1.php">
					...
					<hr><br>
					<ul class="list-group">
						<li class="list-group-item">rjessaissang@gmail.com</li>
						<li class="list-group-item">allaizamaeavila0000@gmail.com</li>
						<li class="list-group-item">maeallaizaavila@gmail.com</li>
						<li class="list-group-item">allaizamaevalenciaavila0000@gmail.com</li>
						<li class="list-group-item">rodmanciria2829@gmail.com</li>
					</ul>
				</div>
